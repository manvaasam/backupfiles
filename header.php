...
<nav class="shadow-sm navbar fixed-top navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item <?php if ($_SERVER['REQUEST_URI'] == "/index1.php") {
                                        echo "active";
                                    } ?>">
                    <a class="nav-link px-3" href="<?= $domainName ?>index1.php">
                ...
                <a class="nav-link px-3" href="https://www.manvaasam.in/" target="_blank">
                ...
                <li class="nav-item <?php if ($_SERVER['REQUEST_URI'] == "/career.php") {
                                        echo "active";
                                    } ?>">
                    <a class="nav-link px-3" href="<?= $domainName ?>career.php">
                        <div class="tab-text">Job</div>
                    </a>
                </li>
            ...
            <ul class="navbar-nav ms-auto">
                 <li>
                    <a class="nav-link" href="https://play.google.com/store/apps/details?id=com.manvaasam.student" target="_blank">
                        <img style="width:40px;height:40px;margin-right: 2%;" src="<?= $domainName ?>image/social/playstore_icon.png">  
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a class="nav-link" href="https://chat.whatsapp.com/CXLKlfhbUxg2eaixVkOGej" target="_blank">
                        <button class="btn btn-success btn-sm">
...
<a href="https://wa.me/916380091001" target="_blank" class="FloatingButton one" style="text-decoration: none;">
...
<div class="FloatingBox card border-1 p-2 text-center">
    ...
    <div class="FloatingBoxInner">
        ...
        <form class="typing-area" id="chatForm" method="POST" onclick="onsubmit()">
...
<script>
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    if (response === 'success') {
                        ...
                        document.querySelector('#chatForm input[name=user_contact]').value = contact;
                        document.cookie = "user_name=" + name + "; expires=" + new Date(new Date().getTime() + (1000 * 60 * 60 * 24 * 365)).toUTCString() + "; path=/";
                        document.cookie = "user_id=" + user_id + "; expires=" + new Date(new Date().getTime() + (1000 * 60 * 60 * 24 * 365)).toUTCString() + "; path=/";
                        document.cookie = "user_contact=" + contact + "; expires=" + new Date(new Date().getTime() + (1000 * 60 * 60 * 24 * 365)).toUTCString() + "; path=/";
    ...
    function onsubmit() {
                <?php
                    $to = "training@manvaasam.com";
                    $subject = "MESSAGE ARRIVED IN CHATBOX";
                    $message = "
                    Hello Manvaasam Team,
                    
                    New Message has been arrived from chat box in manvaasam website.
                ";
                    $headers = "From: training@manvaasam.com" . "\r\n" .
                        "CC:{$email }";
                    try {
                        if($user_name !="" || $usercontact !=""){
